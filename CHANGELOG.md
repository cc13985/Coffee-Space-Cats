...
- Fixed JSON syntax errors in theme file
- Cleaned up duplicate and conflicting token scopes

## [2.2.0]

- Added space/dark aesthetic refinements
- Extended token color coverage for JavaScript, SCSS, and Markdown

## [2.0.0]

- Major theme overhaul with neon pink, purple, and cyan palette
